  ...
  return (
    <section className="rounded-2xl border border-slate-200/90 bg-white shadow-sm shadow-slate-900/5">
      <div className="border-b border-slate-100 px-4 py-3">
        ...
        <p className="mt-0.5 text-xs text-slate-600">Aktuelles Kalenderjahr — scrollbar</p>
      </div>
      <div
            ...
            {rows.map((r) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-slate-500">{dateFmt.format(new Date(r.created_at))}</div>
                </div>
                <span
                  className={
                    r.points >= 0
