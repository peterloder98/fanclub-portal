  ...
  },
  {
    ...
    sections: [
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "Mit dem Antrag wird automatisch eine offene Zahlung per Banküberweisung angelegt (sichtbar unter Admin → Zahlungen). In der Buchhaltungs-Zahlungsliste erscheint noch nichts — erst nach Bestätigung. Der Beitrag (15 € für das laufende Kalenderjahr) muss auf dem Vereinskonto eingegangen sein. Antragsteller/innen sehen als Verwendungszweck „Mitgliedsbeitrag / Vorname Nachname“ (z. B. Mitgliedsbeitrag / Franz Müller). Intern bleibt zusätzlich die Buchungsnummer MITGLIED-… für den Abgleich.",
              "Die Bestätigungs-E-Mail enthält Betrag, Empfänger, IBAN, BIC und denselben namensbasierten Verwendungszweck zum Abtippen.",
              "Unter Admin → Zahlungen den Eingang als bezahlt bestätigen: Pflichtfelder sind der tatsächlich eingegangene Betrag und „Zahlungseingang am“ mit dem Datum vom Kontoauszug. Dann erscheint die Einnahme in der Buchhaltungs-Zahlungsliste und erhöht den Kontostand. Für neu beantragte Mitglieder passiert außerdem automatisch: Status wird aktiv, die nächste freie Mitgliedsnummer wird vergeben, und die Willkommens-E-Mail mit App-Zugang geht raus. Den manuellen Begrüßungspost (Brief/Post) vermerkt ihr im Mitgliedsdatensatz unter „Begrüßungspost“ mit Datum — oder lasst ihn auf „Offen“.",
              ...
              "Sonderfall ohne eigene E-Mail / ohne App (z. B. mit Behinderung): siehe Abschnitt 2.9 — Mitgliedschaft ohne App-Zugang. Auch hier gilt: Zahlungsbestätigung nimmt auf, ohne App-Einladung.",
            ],
          },
          {
            type: "note",
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "Solange eine Zahlung noch nicht bestätigt ist, steht bei der Person „Beitrag offen“ und der Posten bleibt unter Admin → Zahlungen. In der Buchhaltung (Zahlungsliste / Kontostand) erscheint nichts davon. Erst nach Bestätigung unter Zahlungen wird die Einnahme gebucht.",
            ],
          },
          {
            type: "p",
          ...
          },
          {
            ...
            items: [
              ...
              "Die Zahlungsliste und der Kontostand zeigen nur bestätigte Einnahmen und Ausgaben. Offene Antrags-/Beitragszahlungen gehören unter Admin → Zahlungen — nicht in die Kasse, bis ihr den Eingang bestätigt.",
      ...
      },
      {
        id: "ohne-app-zugang",
        number: "2.9",
        title: "Mitgliedschaft ohne App-Zugang",
        summary: "Ohne eigene E-Mail, nur Beitrag",
        blocks: [
          {
            type: "p",
            text: "Manche Mitglieder sollen vollwertig im Verein sein (Beitrag, Mitgliedsnummer, aktiv), aber nicht in die App und nicht in die WhatsApp-Gruppe — zum Beispiel, weil sie keine eigene E-Mail haben oder eine Behinderung das nicht sinnvoll macht.",
          },
          {
            type: "ol",
            items: [
              "Admin → Mitglieder → „+ Person manuell anlegen“.",
              "Häkchen „Kein eigener App-Zugang“ setzen.",
              "Unter „E-Mail nur für Beitragszahlungen“ eine Adresse eintragen, an die Zahlungserinnerungen gehen dürfen — oft die der Mutter oder eines anderen Mitglieds. Dieselbe Adresse darf schon als Login eines anderen Mitglieds verwendet werden.",
              "Name, Anschrift, Beitrag und Status wie üblich. Nach dem Speichern könnt ihr die Zahlungsinfo an genau diese Adresse schicken.",
              "In die WhatsApp-Gruppe nicht aufnehmen — das macht ihr wie bisher manuell; in der App steht der Hinweis am Datensatz.",
            ],
          },
          {
            type: "ul",
            items: [
              "Diese Person erscheint nicht in der Mitglieder-App (Liste, Karte, Geburtstage, Ranglisten).",
              "Sie bekommt keine Gewinnspiel-, Event-, Live- oder App-Erinnerungsmails.",
              "Beitrags- und Zahlungserinnerungen gehen nur an die hinterlegte Zahlungs-Mail. Der Text bezieht sich auf das Mitglied selbst (Name, Verwendungszweck), nicht auf die Person, der die Mailadresse gehört.",
              "Später umstellen geht unter Bearbeiten: Häkchen entfernen und eine eigene Login-E-Mail eintragen.",
            ],
          },
          {
            type: "note",
            text: "Ohne das Häkchen bleibt die Login-E-Mail eindeutig — eine Adresse kann nicht zwei App-Zugänge haben. Nur die Zahlungs-Mail darf geteilt werden.",
          },
          {
            type: "link",
            href: "/admin/members",
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "note",
            text: "Wer den Live-Raum öffnet und länger als eine Minute dabei ist, erhält einmalig +2 Anni-Stars. Pro Mitglied nur eine Vorab-Frage (danach: weitere Fragen im Live-Chat). Während des Live weiterhin max. eine offene Frage. Zugang nur nach Login als aktives Mitglied. Einen Tag vorher erinnert die App per E-Mail und Glocke: Zusagen bekommen den Termin-Hinweis, wer noch nicht reagiert hat eine freundliche Aufforderung zum Zusagen oder Absagen (Absagen erhalten keine Erinnerung). Bis zum Go-Live: Annis Live-Mails an die Testadresse — siehe 7.5.",
          },
          {
            type: "link",
            href: "/admin/live",
