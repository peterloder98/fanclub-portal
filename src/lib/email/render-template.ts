...
<p style="margin:0.5em 0 0;font-size:12px;line-height:1.5;color:#64748b;word-break:break-all">Falls der Button nicht funktioniert:<br>{{setup_url}}</p>
...
<p style="margin:0 0 0.85em;font-size:15px;line-height:1.55;color:#1e293b"><strong>3. Einloggen und App entdecken</strong><br>Nach dem Login kannst du optional fünf kurze Kennenlernfragen beantworten oder diesen Schritt überspringen.<br>Bis zum offiziellen Start am <strong>16.08.2026 um 10:00 Uhr</strong> bitte nur umschauen.</p>
...
<p style="${EMAIL_PARAGRAPH_STYLE}">Die App soll unsere WhatsApp-Gruppe nicht ersetzen, sondern sinnvoll ergänzen.</p>
<p style="${EMAIL_PARAGRAPH_STYLE}">Wir wünschen dir ganz viel Freude beim Entdecken!</p>
<p style="${EMAIL_PARAGRAPH_STYLE};text-align:center">
