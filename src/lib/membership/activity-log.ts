...
export const MEMBER_ACTIVITY_TYPES = {
  ...
  profileChangeRequested: "profile_change_requested",
  ...
  appAccessSuspended: "app_access_suspended",
  appAccessReactivated: "app_access_reactivated",
  appRegistrationDeleted: "app_registration_deleted",
  appRegistrationCleared: "app_registration_cleared",
  welcomeEmailSent: "welcome_email_sent",
  greetingPostSent: "greeting_post_sent",
  greetingPostCleared: "greeting_post_cleared",
  note: "note",
...
export const MEMBER_VISIBLE_ACTIVITY_TYPES = new Set<string>([
  ...
  MEMBER_ACTIVITY_TYPES.profileChangeRequested,
  MEMBER_ACTIVITY_TYPES.profileChangeApproved,
  MEMBER_ACTIVITY_TYPES.profileChangeRejected,
...
export function activityTypeLabel(type: string) {
  const map: Record<string, string> = {
    ...
    profile_change_requested: "Stammdaten-Änderung eingereicht",
    profile_change_approved: "Stammdaten-Änderung freigegeben",
    profile_change_rejected: "Stammdaten-Änderung abgelehnt",
    member_created: "Mitglied angelegt",
    member_deleted: "Mitglied gelöscht",
    app_access_suspended: "App gesperrt",
    app_access_reactivated: "App freigeschaltet",
    app_registration_deleted: "App-Registrierung gelöscht",
    app_registration_cleared: "App-Registrierung zurückgesetzt",
    welcome_email_sent: "Willkommens-Mail gesendet",
    greeting_post_sent: "Begrüßungspost vermerkt",
    greeting_post_cleared: "Begrüßungspost zurückgesetzt",
    note: "Notiz",
