...
values (
  ...
  'Wird 7 und 2 Tage vor dem Treffen nur an angemeldete Mitglieder gesendet. Platzhalter: first_name, meeting_title, meeting_date, meeting_location, meeting_url, cost_hint. Signatur wird automatisch angehängt.'
)
