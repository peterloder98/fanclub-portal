-- E-Mail-Vorlage: App-Zugang einrichten (Hinweis auf Kennenlernen-Fragen)
...
<p style="margin:0 0 1em;font-size:15px;line-height:1.55;color:#1e293b">Viel Spaß und bis ganz bald.</p>$html$,
  'Einladungsmail mit Button zum Einrichten von Geburtsdatum-Bestätigung und Passwort; Hinweis auf optionale Kennenlernen-Fragen'
)
