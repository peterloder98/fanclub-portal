-- App-Zugang Go-Live-Mail: überarbeiteter Text (Live-Chat, Reihenfolge, Soft-Launch)
...
<p style="margin:0 0 1em;font-size:15px;line-height:1.55;color:#1e293b">Mit viel Herzblut haben wir unsere neue offizielle Anni Perka Fanclub-App entwickelt.<br>Heute kannst du bereits rechtzeitig vor dem Start deinen persönlichen Zugang einrichten und alles in Ruhe entdecken.</p>
...
<p style="margin:0 0 1em;font-size:15px;line-height:1.55;color:#1e293b"><strong>Wichtig:</strong> Die Anmeldung ist ab sofort möglich.<br>Die volle Nutzung (Schreiben, Chatten und Mitmachen, Gewinnspiele etc.) startet offiziell am <strong>16.08.2026 um 10:00 Uhr</strong>. Bis dahin kannst du dich nach der Anmeldung gerne umschauen.</p>
...
<p style="margin:0 0 1em;font-size:15px;line-height:1.55;color:#1e293b">Du musst natürlich nicht alles auf einmal entdecken.<br>Schau dich einfach in Ruhe um.<br>In den nächsten Wochen werden wir dir nach und nach einzelne Funktionen und Möglichkeiten der App vorstellen.</p>
...
<p style="margin:0 0 1em;font-size:15px;line-height:1.55;color:#1e293b;text-align:center">
  <a href="{{setup_url}}" style="display:inline-block;margin-top:8px;padding:12px 18px;background:#0b1f3a;color:#ffffff;text-decoration:none;border-radius:10px;font-weight:600">Jetzt meinen Zugang einrichten</a>
</p>
$html$,
  description = 'Go-Live Einladung (13.08.2026) — aktuelle Fassung',
  updated_at = now()
where key = 'app_access_setup';
